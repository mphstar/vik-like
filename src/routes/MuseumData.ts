...
export const MUSEUMS: Museum[] = [
    {
        ...
        panorama: 'https://raw.githubusercontent.com/jariq/KUK360/refs/heads/main/img/KUK360-Photo-Sample.jpg',
        explanations: [
            { title: 'Diorama Hutan Hujan', description: 'Gambaran ekosistem hutan hujan tropis beserta spesimen kunci.', image: 'https://placehold.co/128x128/png?text=H1' },
            { title: 'Galeri Fosil', description: 'Koleksi fosil vertebrata purba dari berbagai era geologi.', image: 'https://placehold.co/128x128/png?text=H2' },
            { title: 'Laboratorium Botani', description: 'Area konservasi spesimen flora dan riset botani.', image: 'https://placehold.co/128x128/png?text=H3' }
        ],
        categories: [
    ...
    },
    {
        ...
        panorama: 'https://raw.githubusercontent.com/jariq/KUK360/refs/heads/main/img/KUK360-Photo-Sample.jpg',
        explanations: [
            { title: 'Galeri Kapal', description: 'Replika kapal dari berbagai era perjalanan nusantara.', image: 'https://placehold.co/128x128/png?text=M1' },
            { title: 'Ruang Navigasi', description: 'Instrumen navigasi dan peta ekspedisi maritim.', image: 'https://placehold.co/128x128/png?text=M2' },
            { title: 'Rute Rempah', description: 'Pameran jalur perdagangan rempah-rempah.', image: 'https://placehold.co/128x128/png?text=M3' }
        ],
        categories: [
    ...
    },
    {
        ...
        panorama: 'https://raw.githubusercontent.com/jariq/KUK360/refs/heads/main/img/KUK360-Photo-Sample.jpg',
        explanations: [
            { title: 'Busana Adat', description: 'Koleksi pakaian adat dari berbagai daerah.', image: 'https://placehold.co/128x128/png?text=B1' },
            { title: 'Alat Musik', description: 'Instrumen musik tradisional dan penjelasan fungsinya.', image: 'https://placehold.co/128x128/png?text=B2' },
            { title: 'Ritual', description: 'Ritual dan kepercayaan yang menyertai siklus hidup.', image: 'https://placehold.co/128x128/png?text=B3' }
        ],
        categories: [
